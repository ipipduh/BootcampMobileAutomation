...
import static com.pnt.bootcampmobile.ExtentTestManager.getTime;
...
public class TestBase {
    ...
    public void extentSetup(ITestContext context) {
        com.pnt.bootcampmobile.ExtentTestManager.setOutputDirectory(context);
        extent = com.pnt.bootcampmobile.ExtentTestManager.getInstance();
    }
    ...
    public void startExtent(Method method) {
        ...
        com.pnt.bootcampmobile.ExtentTestManager.startTest(method.getName());
        com.pnt.bootcampmobile.ExtentTestManager.getTest().assignCategory(className);
    }

    //Extent Report
    @AfterMethod
    public void afterEachTestMethod(ITestResult result) {
        com.pnt.bootcampmobile.ExtentTestManager.getTest().getTest().setStartedTime(getTime(result.getStartMillis()));
        com.pnt.bootcampmobile.ExtentTestManager.getTest().getTest().setEndedTime(getTime(result.getEndMillis()));
        for (String group : result.getMethod().getGroups()) {
            com.pnt.bootcampmobile.ExtentTestManager.getTest().assignCategory(group);
        }

        if (result.getStatus() == 1) {
            com.pnt.bootcampmobile.ExtentTestManager.getTest().log(LogStatus.PASS, "TEST CASE PASSED : " + result.getName());
        } else if (result.getStatus() == 2) {
            com.pnt.bootcampmobile.ExtentTestManager.getTest().log(LogStatus.FAIL, "TEST CASE FAILED : " + result.getName() + " :: " + com.pnt.bootcampmobile.ExtentTestManager.getStackTrace(result.getThrowable()));
        } else if (result.getStatus() == 3) {
            com.pnt.bootcampmobile.ExtentTestManager.getTest().log(LogStatus.SKIP, "TEST CASE SKIPPED : " + result.getName());
        }
        com.pnt.bootcampmobile.ExtentTestManager.endTest();
        extent.flush();
        if (result.getStatus() == ITestResult.FAILURE) {
            com.pnt.bootcampmobile.ExtentTestManager.captureScreenshot(driver, result.getName());
        }
    }
